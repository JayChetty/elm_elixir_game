		...
		switch (_p1.ctor) {
			...
			case 'JoinDataChannel':
				...
				if (_p3.ctor === 'Just') {
						...
						A2(
							...
							A2(
								...
								A2(
									...
									_user$project$Main$userEncoder(_p3._0),
					...
					var phxCmd = _p4._1;
					var _p5 = A2(_elm_lang$core$Debug$log, 'UPDATE', 'Trying to join data channel');
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
			...
			case 'ShowJoinDataErrorMessage':
				var _p6 = A2(_elm_lang$core$Debug$log, 'JOIN ERROR MESSAGE', _p1._0);
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
